 ...
 * @author songqian
 */
class SettingSettingMenuService
{
    public function handle($options)
    {
        $shop_manage   = ecjia_admin::make_admin_menu('01_setting_shop_manage', __('商店设置', 'setting'), RC_Uri::url('setting/shop_config/init'), 1)->add_purview('shop_config');
