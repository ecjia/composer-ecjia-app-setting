...
//  ---------------------------------------------------------------------------------
//
namespace Ecjia\App\Setting\ApiControllers\Shop;
...
class ConfigController extends api_front implements api_interface
{
    ...
    public function handleRequest($request)
    {
        ...
        $data = array(
            ...
            'service_qq'        => ecjia::config('qq') ? explode(',', ecjia::config('qq')) : array(),
			'site_url'          => ecjia::config('mobile_pc_url') ? ecjia::config('mobile_pc_url') : RC_Config::load_config('site', 'CUSTOM_SITE_URL'),
            'goods_url'         => ecjia::config('mobile_touch_url') ? ecjia::config('mobile_touch_url').'?m=goods&c=index&a=init&id=' : (ecjia::config('mobile_pc_url') ? ecjia::config('mobile_pc_url') : RC_Config::system('CUSTOM_WEB_SITE_URL') . '/goods.php?id='),
        ...
        $data['mobile_app_icon'] = ecjia::config('mobile_app_icon') ? RC_Upload::upload_url(ecjia::config('mobile_app_icon'))  : '';
        ...
        $data['wap_app_download_img'] = ecjia::config('wap_app_download_img') ? RC_Upload::upload_url(ecjia::config('wap_app_download_img'))  : '';
        $data['shop_mobile_logo'] = ecjia::config('mobile_app_icon') ? RC_Upload::upload_url(ecjia::config('mobile_app_icon')) : '';
        
        $client = \Ecjia\App\Client\Client::H5;
